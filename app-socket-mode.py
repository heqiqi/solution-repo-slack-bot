...
openai.api_base = "https://api.aihubmix.com/v1"  # Add this line
...
def handle_message(event, say):
    ...
    print(f"Received message: {event}#{say}")
    ...
    say(list(response.values())[0],thread_ts=event["ts"])
